...
function checkForSets(event)
    if canRun == true then
        ...
        if waitForLowerBound == true and totalChange < lowerBound then
            ...
            function speakDelay()
               texttospeech.speak(numTimeHold)  
               ...
               numTimeHold = 1
                   ...
                   if numHalfReps % 2 ~= 0 then
                        ...
                        function goRepsRest( ... )
                            ...
                            texttospeech.speak(repsCompleted.." Reps Completed")
                            repsRestTimer.isActive = false
                        end
                        end
                        function goUpRest( ... )
                            texttospeech.speak("Up")
                   ...
                   if(repsCompleted == thisReps and numHalfReps/2 > repsCompleted) then
                        texttospeech.speak('Set Finished, Well Done!')  
                        ...
                        playCompletedLevel()
                        texttospeech.speak('Workout Complete') 
                        showSummaryScreen()
                        else
                        repsCompleted = 0
                        canRun = true
...
caloriesBurnedText=display.newText("Calories: ".._G.mySets, 0, 0, "Helvetica-Bold", screenWidth/10)
